...
Multiple layers can be combined and visualized within the Data Portal by creating maps. See [Managing Maps](https://docs.geonode.org/en/4.3.0/usage/managing_maps/index.html){target="_blank"} in the GeoNode documentation for more information.
