...
::: two-col
```{r, echo=F, fig.cap=c("Register account")}

knitr::include_graphics("images/4.3.0/user_reg.png")

```

```{r, echo=F, fig.cap=c("User profile")}
...
3.  Edit your user profile to include your name and institution.

4.  Join the group for your Landscape or Theme. Please note, in some cases the Data Manager and/or Group Manager will need to do this for you.
:::
...
2.  Select the PDF file you saved from the Metadata Questionnaire in the previous step.
...
4.  Once the items have are ready, view the resource and click `Edit -> Edit Metadata`. Complete the form like you did for the the project description in the previous section.
...
4. If there are no restrictions due to data sensitivity or publication embargo, the layer will be made visible to the public.
